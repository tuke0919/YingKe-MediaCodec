//
// Created by KE TU on 2019/8/20.
//


#include "com_yingke_mediacodec_compose_AudioMixJni.h"
#include <string>

JNIEXPORT jbyteArray JNICALL Java_com_yingke_mediacodec_compose_AudioMixJni_audioMix
  (JNIEnv * env, jclass type, jbyteArray sourceA_, jbyteArray sourceB_, jbyteArray dst_, jfloat firstVol, jfloat
  secondVol){
