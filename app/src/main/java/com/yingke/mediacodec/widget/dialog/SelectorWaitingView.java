...
public class SelectorWaitingView extends ImageView implements PictureIndeterminate {
    ...
    public SelectorWaitingView(Context context) {
        super(context);
        init();
    }

    public SelectorWaitingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
